      ...
      if (mounted) {
        setState(() {
          _settings = _settings!.copyWith(
            ...
            newJobOffers: settingKey == 'newJobOffers'
                ? value
                : _settings!.newJobOffers,
            applicationStatus: settingKey == 'applicationStatus'
                ? value
                : _settings!.applicationStatus,
            jobRecommendations: settingKey == 'jobRecommendations'
                ? value
                : _settings!.jobRecommendations,
                ...
                ListView(
                  ...
                  children: [
                    ...
                    _buildSettingTile(
                      title: 'Messages',
                      subtitle:
                          'Notifications des nouveaux messages des établissements',
                      icon: Icons.message,
                    ...
                    _buildSettingTile(
                      ...
                      subtitle:
                          'Soyez informé des nouvelles offres correspondant à votre profil',
                      icon: Icons.work,
                      value: _settings!.newJobOffers,
                      onChanged: (value) =>
                          _updateSetting('newJobOffers', value),
                    ),
                    _buildSettingTile(
                      title: 'Recommandations',
                      subtitle:
                          'Recevez des offres personnalisées selon vos préférences',
                      icon: Icons.star,
                    ...
                    _buildSettingTile(
                      ...
                      subtitle:
                          'Notifications lorsque vos candidatures sont acceptées ou refusées',
